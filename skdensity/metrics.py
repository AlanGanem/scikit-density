...
__all__ = ['kde_entropy', 'kde_likelihood', 'quantile', 'kde_quantile', 'quantile_sklearn', 'theoretical_entropy',
           'marginal_variance', 'covariance_matrix', 'bimodal_split', 'agg_smallest_distance', 'cov_smallest_distance',
           'mad', 'bimodal_variance', 'gaussian_distance_entropy', 'expected_distance_gaussian_likelihood',
           'distance_gaussian_likelihood', 'make_outlier_filter', 'filter_borders']
...
# Cell
def kde_entropy(data, sample_size = 200, progress_bar = False, **kde_kwargs):
    '''
...
# Cell
def kde_likelihood(y_true,y_dists, progress_bar = False,**kde_kwargs):
    '''
...
# Cell
def kde_quantile(y_true, y_dists, progress_bar = False, **kde_kwargs):
    '''
